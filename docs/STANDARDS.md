...
| Toolchain/versioni | Runtime, package manager, lockfile e versioni minime dichiarati | OK; FiscalBay resta in stato Python misto da decidere separatamente |
...
| FiscalBay | OK | OK | OK | OK | N/A | OK | Resta bloccante separato: Python runtime documentato `3.13`, manifest/CI `3.10` |
...
| SendChimp | OK | OK | OK | OK locale | OK | OK | PR `max23468/SendChimp#21`: `quality:react-doctor`, `docs/CONTEXT.md`, React Doctor `100 / 100` |
| SyncBay | OK | OK | OK | OK locale | OK | OK | PR `max23468/SyncBay#30` ha aggiunto `pr-title.yml`; no release/deploy/App Store |
| TRAM | Parziale | OK | OK | Parziale | OK | OK | Manca ancora policy SemVer/release; `docs/DECISIONS.md` resta registro, manca indice ADR canonico |
| Sentinel | OK | OK | OK | Parziale | N/A | Sospeso | PR `max23468/Sentinel#2` ha aggiunto Codex inbox; issue `#4` pulita; Dependabot sospeso per budget Actions |
...
- SendChimp: PR `max23468/SendChimp#21` mergiata; aggiunto
  ...
  corretto export non usato e verificato React Doctor `100 / 100`.
