...
| React Doctor | Obbligatorio per app React dopo release major/minor o modifiche React trasversali; comando standard `npm run quality:react-doctor` con `npx react-doctor@latest` | `OK pieno`: applicato in Pratix, GLM, SendChimp, SyncBay, TRAM e Sentinel |
