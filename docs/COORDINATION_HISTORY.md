# Cronologia coordinamento Atlas

Archivio storico della vecchia roadmap estesa. Non è la roadmap canonica:
priorità e prossimi passi correnti stanno in `ROADMAP.md`.

Data ultimo aggiornamento: 2026-05-31

Questo snapshot descriveva direzione, priorità e prossimi passi di Atlas. Le idee non ancora scelte stanno in `BACKLOG.md`.
