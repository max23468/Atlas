...
- [ ] Definire una checklist semantica Atlas.
...
- [ ] Riallineare i basename Markdown duplicati.
  - Verdetto: da riallineare.
...
- [ ] Normalizzare il contenuto dei `docs/CONTEXT.md` non template-style.
  - Verdetto: da riallineare.
...
- [ ] Rendere più esplicito negli indici il rapporto con root docs e `AGENTS.md`.
  - Verdetto: da riallineare.
...
- [ ] Uniformare la frase "il backlog non è scope approvato".
  - Verdetto: da riallineare.
...
- [ ] Marcare sempre le eccezioni motivate come tali.
  - Verdetto: da riallineare.
...
- [ ] Riallineare Dependabot dove oggi è sospeso.
...
- [ ] Riallineare SyncBay a un flusso release più standard.
...
- [ ] Riallineare DocMolder a una pubblicazione proporzionata standard Atlas.
...
- [ ] Definire in futuro un target deploy per TRAM.
...
- [ ] Promuovere il modello decisionale completo a standard pieno.
...
- [ ] Riallineare changelog/versioning locale verso tag e GitHub Release.
...
- [ ] Riallineare i `docs/CONTEXT.md` che dichiarano una versione statica non aggiornata.
...
- FiscalBay: il supporto Python `>=3.10` non è più un'eccezione da preservare;
  va riallineato a Python `3.13` in un intervento dedicato.
