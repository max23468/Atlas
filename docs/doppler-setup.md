...
## Stato attuale repo
- `DOPPLER_PROJECT` impostato a: `Atlas`
...
```bash
gh variable set DOPPLER_PROJECT --body "Atlas" --repo max23468/Atlas
gh variable set DOPPLER_CONFIG --body "production" --repo max23468/Atlas

gh secret set DOPPLER_TOKEN --body "<service_token_read_only>" --repo max23468/Atlas
```
