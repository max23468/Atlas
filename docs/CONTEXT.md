...
- Ciclo correttivo standard Atlas: creata `docs/STANDARDS.md`; pubblicate
  ...
  GitHub sono stati verificati (`active`) in sede post-riavvio: DocMolder `Release
  Please`, GLM `CI`, TRAM `Repo Hygiene`, SyncBay `PR Title` e Sentinel runtime.
