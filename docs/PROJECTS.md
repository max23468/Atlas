...
| Pratix | Hardening operativo in corso (prima fase: riduzione rischio tecnico-operations trasversale) | TanStack Start, Node/npm, Vercel, Supabase | Nessuna PR aperta; inbox Codex `#34`; PR `#159` chiusa; Vercel production `READY` con commit `59fbb05`, `/` e `/novita` `200`; nessuna release SemVer richiesta dal dry-run | `AGENTS.md`; `docs/ROADMAP.md`; `docs/INDEX.md`; `docs/BACKLOG.md`; `docs/CONTEXT.md`; `docs/TOOLCHAIN.md`; `docs/DECISIONS.md`; `docs/DECISIONS_PENDING.md`; `docs/memory/`; `docs/decisions/`; `docs/guides/versioning-e-release.md`; `docs/guides/deploy.md` | UI italiana, glossary rigoroso, token semantici; non spostare verso VPS, Telegram o Cloudflare | Eseguire checklist Pratix-hardening (ambienti, segreti in repo, integrazioni, workflow minimi) prima di nuovi interventi funzionali | Rischi prioritari: esposizione `.env` tracciati, integrazioni esterne e controlli di sicurezza minimi; nessuna rotazione segreti richiesta nel piano corrente |
