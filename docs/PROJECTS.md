...
| FiscalBay | Seconda ondata completata; operativo Telegram/eBay/VPS con fix deploy pubblicato | Supporto Python dichiarato `>=3.10`; VPS operativa `3.13` come compatibilità runtime controllata | PR `max23468/FiscalBay#78` mergiata; thread Codex P1 risolto; inbox `#69` senza actionable; deploy/release non eseguiti in questo ciclo | `AGENTS.md`; `docs/ROADMAP.md`; `docs/BACKLOG.md`; `docs/TOOLCHAIN.md`; `docs/decisions/`; `docs/MILESTONE_BOARD.md`; `docs/INDEX.md`; `docs/CONTEXT.md`; `docs/RELEASE_POLICY.md`; `docs/OPERATIONS.md`; `docs/RUNBOOK.md`; `docs/DECISIONS_PENDING.md` | Non dedurre dati fiscali eBay assenti; non usare sintassi o dipendenze `>3.10` finché manifest/CI non cambiano | Valutare upgrade Python completo solo con decisione repo-specifica | Non confondere compatibilità runtime VPS `3.13` con obbligo di rompere supporto `>=3.10` |
