...
| SyncBay | Primo allineamento Atlas completato e release locale `0.6.0` pubblicata su `main` | Shopify app; eBay sorgente catalogo; Vercel/Supabase; Vercel automatico presente ma no tag/GitHub Release/App Store production | Nessuna PR aperta; nessuna inbox Codex aperta; ultimo run GitHub: `PR Title` fallita il `2026-05-26`; Dependabot presente | `AGENTS.md`; `README.md`; `docs/INDEX.md`; `docs/ROADMAP.md`; `docs/BACKLOG.md`; `docs/CONTEXT.md`; `docs/TOOLCHAIN.md`; `docs/decisions/`; `docs/decisions-pending.md`; `docs/guides/git-e-pubblicazione.md`; `docs/guides/versioning-e-release.md`; `docs/guides/provisioning-runtime.md` | Non trasformare in marketplace generico bidirezionale; App Store solo dopo decisione; niente tag/GitHub Release finché la policy non cambia | Nessuna azione prodotto Atlas; keyset/OAuth o import live solo se richiesti come scope SyncBay | Per questo aggiornamento non viene usato come segnale il checkout locale temporaneamente in lavorazione; resta da osservare il failure recente su `PR Title` |
| TRAM | Allineamento Atlas, React Doctor e policy release completati su `main` | Next.js 16, React 19, TypeScript, npm, Vitest, Python documentale `3.12` locale | Nessuna PR aperta; inbox Codex `#2`; ultimo run GitHub: `Dependabot Updates` cancellato il `2026-05-25`; commit release policy `783b783` `[skip ci]` | `AGENTS.md`; `README.md`; `docs/INDEX.md`; `docs/ROADMAP.md`; `docs/BACKLOG.md`; `docs/CONTEXT.md`; `docs/TOOLCHAIN.md`; `docs/OPERATIONS.md`; `docs/DECISIONS.md`; `docs/decisions/` | Evidence-first; AI free-first e governata; basename Markdown univoci; non anticipare V2/V3; non inviare documenti sensibili a provider senza policy; release distinta da deploy | Nessuna azione prodotto Atlas; pilot/provider/hardening solo se richiesti come scope TRAM | Nessun target deploy approvato: non deployare TRAM finché manca runbook/target; per questo aggiornamento non viene usato come segnale il checkout locale temporaneamente in lavorazione |
