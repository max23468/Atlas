...
Le prossime direzioni possibili, entrambe da confermare esplicitamente, sono:

1. consolidare Sentinel come baseline runtime separata;
2. avviare la seconda ondata.
